...
import { MessageSquare, Megaphone, Calendar, AlertCircle, X } from 'lucide-react';
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '12px 14px 10px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 4 }}>
          <span style={{ fontFamily: fonts.mono, fontSize: 10, color: c.warmGray }}>{toast.time}</span>
          <button
      ...
      <div style={{ height: 3, background: 'rgba(0,0,0,0.06)' }}>
        <motion.div
          style={{ height: '100%', background: config.color, transformOrigin: 'left' }}
